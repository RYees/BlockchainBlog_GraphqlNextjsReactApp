...
//  console.log(post)
  return (
    <div className='bg-white bg-opacity-90 shadow-lg rounded-lg p-0 lg:p-8 pb-12 mb-8'>
       <h1 className='transition duration-100 text-center mb-8 cursor-ponter hover:text-pink-600 text-3xl font-semibold'>
